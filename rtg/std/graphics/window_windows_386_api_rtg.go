...
// rtg:linkstatic kernel32.dll,GetModuleHandleA
func windowsGetModuleHandle(name *byte) int { return 0 }

// rtg:linkstatic kernel32.dll,WideCharToMultiByte
