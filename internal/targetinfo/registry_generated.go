...
func descriptorAt(index int) Descriptor {
	...
	if index == 8 {
		return Descriptor{Name: "wasi/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "wasi", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x6, 0xa8, 0x35, 0x92, 0x2b, 0x5f, 0x2, 0xf1, 0x62, 0x87, 0x15, 0xc8, 0x1e, 0x22, 0xba, 0x53, 0x57, 0x11, 0x6e, 0x2f, 0x7b, 0xdf, 0x2d, 0x2f, 0x91, 0x20, 0xa5, 0x21, 0xd4, 0xe7, 0x5c, 0x16}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "", IDE: false}
	}
	if index == 9 {
		return Descriptor{Name: "browser/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "browser", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "html-wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"browser", "wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x49, 0x1a, 0xb0, 0xb1, 0x83, 0x7e, 0x66, 0x50, 0x81, 0x72, 0xbf, 0xb8, 0x87, 0xf6, 0x66, 0xfe, 0x71, 0x1a, 0xcc, 0xcf, 0xba, 0x92, 0x6, 0x21, 0x26, 0x30, 0x80, 0x5a, 0xd9, 0x7f, 0xcd, 0x7d}, DescriptorVersion: 3, Advertised: true, Virtual: true, DefaultArena: 134217728, ReleaseArtifact: "", IDE: true}
	}
	if index == 10 {
		return Descriptor{Name: "vm/vm32", Backend: "vm/vm32", Aliases: []string(nil), Family: "structured32", OS: "vm", ISA: "vm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "rnvm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"vm", "vm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x40, 0xf3, 0xc1, 0xbb, 0x5c, 0xa5, 0xc7, 0x28, 0x38, 0x90, 0xfe, 0x69, 0x68, 0x25, 0x2a, 0xcd, 0x5f, 0x0, 0xdc, 0xfd, 0xc2, 0x4c, 0xa5, 0xec, 0x3b, 0x72, 0xc1, 0xa, 0xf2, 0x62, 0x8b, 0x53}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "", IDE: false}
	}
	if index == 11 {
...
func Binding(name string) (string, string, int, bool) {
	...
	if name == "browser/wasm32" {
		return "browser/wasm32", "\x49\x1a\xb0\xb1\x83\x7e\x66\x50\x81\x72\xbf\xb8\x87\xf6\x66\xfe\x71\x1a\xcc\xcf\xba\x92\x06\x21\x26\x30\x80\x5a\xd9\x7f\xcd\x7d", 3, true
	}
	if name == "vm/vm32" {
