...
func descriptorAt(index int) Descriptor {
	...
	if index == 8 {
		return Descriptor{Name: "wasi/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "wasi", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xe4, 0xc2, 0x5a, 0xdc, 0xdf, 0x16, 0x84, 0xe0, 0xdc, 0xaa, 0x50, 0x79, 0x94, 0xdd, 0xcc, 0xdb, 0x56, 0x78, 0x4a, 0xa4, 0xbb, 0x8f, 0x9b, 0xd7, 0xaf, 0xb9, 0x98, 0x61, 0xd7, 0x9a, 0x58, 0xe7}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "", IDE: false}
	}
	if index == 9 {
		return Descriptor{Name: "browser/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "browser", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "html-wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"browser", "wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xbc, 0x5a, 0x1, 0xb9, 0xe2, 0x35, 0xe0, 0xa8, 0x4, 0xaf, 0xa3, 0xff, 0xe, 0x92, 0x4a, 0x56, 0x2d, 0x47, 0x46, 0x16, 0xaa, 0xfa, 0xc5, 0xb3, 0xc8, 0x14, 0x4, 0xfa, 0x6, 0x70, 0xc6, 0x3e}, DescriptorVersion: 3, Advertised: true, Virtual: true, DefaultArena: 134217728, ReleaseArtifact: "", IDE: true}
	}
	if index == 10 {
		return Descriptor{Name: "vm/vm32", Backend: "vm/vm32", Aliases: []string(nil), Family: "structured32", OS: "vm", ISA: "vm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "rnvm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"vm", "vm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x41, 0xd4, 0xf1, 0xbc, 0x21, 0xfe, 0x6c, 0xbe, 0x41, 0x2, 0xbb, 0xab, 0x7a, 0x64, 0xe4, 0xe5, 0xaf, 0x2, 0x54, 0x36, 0xa0, 0xfd, 0x75, 0xa7, 0xc5, 0x6b, 0xd7, 0x6c, 0x6c, 0x8a, 0x43, 0xff}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "", IDE: false}
	}
	if index == 11 {
...
func Binding(name string) (string, string, int, bool) {
	...
	if name == "browser/wasm32" {
		return "browser/wasm32", "\xbc\x5a\x01\xb9\xe2\x35\xe0\xa8\x04\xaf\xa3\xff\x0e\x92\x4a\x56\x2d\x47\x46\x16\xaa\xfa\xc5\xb3\xc8\x14\x04\xfa\x06\x70\xc6\x3e", 3, true
	}
	if name == "vm/vm32" {
