...
func descriptorAt(index int) Descriptor {
	...
	if index == 5 {
		return Descriptor{Name: "windows/386", Backend: "windows/386", Aliases: []string(nil), Family: "native_v1", OS: "windows", ISA: "386", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 4, Endian: "little", ABI: "win32", Image: "pe", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"386", "windows"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xa0, 0x92, 0xef, 0x31, 0x25, 0x81, 0xf8, 0xfd, 0x8a, 0x3c, 0x22, 0x4c, 0x73, 0x14, 0x56, 0x4a, 0x6, 0xc, 0xa8, 0xf4, 0xbc, 0x80, 0x84, 0xeb, 0x94, 0x4b, 0x9c, 0x4a, 0x28, 0x64, 0x83, 0xf2}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-windows-386.exe", IDE: true}
	}
	if index == 6 {
