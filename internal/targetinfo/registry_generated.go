...
func descriptorAt(index int) Descriptor {
	...
	if index == 2 {
		return Descriptor{Name: "linux/aarch64", Backend: "linux/aarch64", Aliases: []string(nil), Family: "native_v1", OS: "linux", ISA: "aarch64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "aapcs64", Image: "elf", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "exit", "hosted"}, Tags: []string{"aarch64", "arm64", "linux", "unix"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xd8, 0x31, 0x8e, 0xb1, 0xd2, 0x41, 0x19, 0x5c, 0x89, 0xdb, 0xd8, 0x46, 0x12, 0xc1, 0x5d, 0xbf, 0x71, 0x7d, 0x8e, 0xa9, 0x1d, 0xce, 0x66, 0x95, 0xc2, 0x86, 0x89, 0x8, 0xa1, 0xdd, 0x33, 0x15}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-linux-arm64", IDE: false}
	}
	if index == 3 {
	...
	if index == 4 {
		return Descriptor{Name: "windows/amd64", Backend: "windows/amd64", Aliases: []string(nil), Family: "native_v1", OS: "windows", ISA: "amd64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "windows_x86_64", Image: "pe", Runtime: []string{"open", "close", "read", "write", "read_at", "write_at", "seek", "print", "chmod", "exit", "hosted"}, Tags: []string{"amd64", "windows"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted", "imports", "linkstatic", "object", "windows_gui"}, Definition: [32]uint8{0x6f, 0xf6, 0x1d, 0xbd, 0x2f, 0xb7, 0x63, 0xd9, 0x25, 0xc8, 0x84, 0xc7, 0xcb, 0x17, 0xb1, 0xd7, 0x4d, 0x63, 0x36, 0x27, 0x4d, 0xae, 0x76, 0x89, 0xd2, 0xd, 0x37, 0xa3, 0x2a, 0x74, 0xc6, 0xb8}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-windows-amd64.exe", IDE: true}
	}
	if index == 5 {
		return Descriptor{Name: "windows/386", Backend: "windows/386", Aliases: []string(nil), Family: "native_v1", OS: "windows", ISA: "386", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 4, Endian: "little", ABI: "win32", Image: "pe", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"386", "windows"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x91, 0x83, 0xec, 0x9d, 0x51, 0x19, 0x84, 0xb9, 0x13, 0xcd, 0x6, 0x39, 0x4e, 0x77, 0xc3, 0x4a, 0xc3, 0xb2, 0xab, 0xab, 0xa6, 0x38, 0xbc, 0x76, 0x2e, 0x48, 0x4a, 0xa6, 0x32, 0x2c, 0x1e, 0x6e}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-windows-386.exe", IDE: true}
	}
	if index == 6 {
		return Descriptor{Name: "windows/arm64", Backend: "windows/arm64", Aliases: []string(nil), Family: "native_v1", OS: "windows", ISA: "aarch64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "windows_arm64", Image: "pe", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"aarch64", "arm64", "windows"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted", "windows_gui"}, Definition: [32]uint8{0xe3, 0xbc, 0xf5, 0xf3, 0xda, 0x4e, 0x22, 0x9a, 0x88, 0xa5, 0x4b, 0x58, 0x82, 0x5c, 0x73, 0x85, 0xf3, 0xff, 0x5a, 0x88, 0x8c, 0x97, 0x2d, 0xf7, 0x29, 0x8e, 0xeb, 0x7c, 0x99, 0xb, 0x99, 0xbb}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-windows-arm64.exe", IDE: true}
	}
	if index == 7 {
		return Descriptor{Name: "darwin/arm64", Backend: "darwin/arm64", Aliases: []string(nil), Family: "native_v1", OS: "darwin", ISA: "aarch64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "aapcs64", Image: "mach-o", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"aarch64", "arm64", "darwin", "unix"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x71, 0x37, 0x91, 0xdf, 0x28, 0xa1, 0x78, 0x22, 0xa2, 0x13, 0xc2, 0x6a, 0x37, 0x49, 0x52, 0x3e, 0x11, 0x41, 0xd8, 0x98, 0x9e, 0x11, 0x7d, 0xcc, 0x1e, 0x6, 0x79, 0x55, 0xd5, 0xcb, 0x7b, 0xd}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-darwin-arm64", IDE: true}
	}
	if index == 8 {
		return Descriptor{Name: "wasi/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "wasi", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x8, 0x7e, 0xfa, 0xc3, 0xf6, 0xde, 0xf8, 0xab, 0x4e, 0x18, 0xc8, 0xbd, 0xf5, 0xe7, 0x1, 0x3, 0xaa, 0x9f, 0xd8, 0x1f, 0x4c, 0xf5, 0xb7, 0x1f, 0x52, 0xa7, 0x78, 0x4f, 0xc2, 0x14, 0xa, 0xd5}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-wasi-wasm32.wasm", IDE: false}
	}
	if index == 9 {
		return Descriptor{Name: "browser/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "browser", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "html-wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"browser", "wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x27, 0x55, 0x9f, 0x58, 0xd3, 0xf4, 0x85, 0xcf, 0xbe, 0xe2, 0x15, 0x89, 0x32, 0xb3, 0x10, 0x43, 0xbc, 0xa1, 0x24, 0xf3, 0x1b, 0x76, 0xcb, 0x2f, 0x35, 0xa8, 0x7e, 0x64, 0x6f, 0x98, 0x9b, 0x28}, DescriptorVersion: 3, Advertised: true, Virtual: true, DefaultArena: 134217728, ReleaseArtifact: "", IDE: true}
	}
	if index == 10 {
...
func Binding(name string) (string, string, int, bool) {
	...
	if name == "browser/wasm32" {
		return "browser/wasm32", "'U\x9fX\xd3\xf4\x85Ͼ\xe2\x15\x892\xb3\x10C\xbc\xa1$\xf3\x1bv\xcb/5\xa8~do\x98\x9b(", 3, true
	}
	if name == "vm/vm32" {
