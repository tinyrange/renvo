...
func descriptorAt(index int) Descriptor {
	...
	if index == 8 {
		return Descriptor{Name: "wasi/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "wasi", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xdb, 0x73, 0xca, 0xf, 0xa2, 0xe8, 0x46, 0xda, 0xee, 0x41, 0x93, 0x2, 0xe9, 0x80, 0xb0, 0x88, 0xf8, 0xba, 0x37, 0x5b, 0x31, 0x17, 0x30, 0x6, 0xb5, 0x1a, 0x78, 0x53, 0x85, 0x6b, 0x6b, 0xe0}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "", IDE: false}
	}
	if index == 9 {
		return Descriptor{Name: "browser/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "browser", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "html-wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"browser", "wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x80, 0x5, 0x92, 0xf4, 0xf7, 0x8f, 0xcc, 0xbc, 0x71, 0x60, 0x34, 0x11, 0x52, 0xcf, 0xc1, 0x1, 0xe4, 0x25, 0x3e, 0xcc, 0x6c, 0xe3, 0x5, 0xbf, 0x2d, 0x87, 0xd, 0xd5, 0x3b, 0xa7, 0x94, 0x70}, DescriptorVersion: 3, Advertised: true, Virtual: true, DefaultArena: 134217728, ReleaseArtifact: "", IDE: true}
	}
	if index == 10 {
		return Descriptor{Name: "vm/vm32", Backend: "vm/vm32", Aliases: []string(nil), Family: "structured32", OS: "vm", ISA: "vm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "rnvm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"vm", "vm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x3c, 0xb9, 0xad, 0x62, 0x9f, 0x35, 0x1, 0x38, 0x44, 0x14, 0x6a, 0x27, 0x9a, 0xb6, 0x1d, 0xc1, 0xa1, 0x39, 0xfe, 0x24, 0x6c, 0xea, 0xe, 0x58, 0x42, 0x37, 0x68, 0xd, 0xc2, 0x6a, 0x3, 0x6b}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "", IDE: false}
	}
	if index == 11 {
...
func Binding(name string) (string, string, int, bool) {
	...
	if name == "browser/wasm32" {
		return "browser/wasm32", "\x80\x05\x92\xf4\xf7\x8f\xcc\xbc\x71\x60\x34\x11\x52\xcf\xc1\x01\xe4\x25\x3e\xcc\x6c\xe3\x05\xbf\x2d\x87\x0d\xd5\x3b\xa7\x94\x70", 3, true
	}
	if name == "vm/vm32" {
