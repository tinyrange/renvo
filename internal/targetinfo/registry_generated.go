...
func descriptorAt(index int) Descriptor {
	...
	if index == 4 {
		return Descriptor{Name: "windows/amd64", Backend: "windows/amd64", Aliases: []string(nil), Family: "native_v1", OS: "windows", ISA: "amd64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "windows_x86_64", Image: "pe", Runtime: []string{"open", "close", "read", "write", "read_at", "write_at", "seek", "print", "chmod", "exit", "hosted"}, Tags: []string{"amd64", "windows"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted", "imports", "linkstatic", "object", "windows_gui"}, Definition: [32]uint8{0xa8, 0x93, 0xea, 0xcc, 0xb4, 0x7d, 0x67, 0x6a, 0x12, 0x21, 0x62, 0x69, 0xe6, 0xce, 0x29, 0x7a, 0x7, 0x24, 0x80, 0xc0, 0x9d, 0x65, 0x48, 0x36, 0x58, 0x1d, 0x42, 0xf6, 0x19, 0x8d, 0x29, 0x6b}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-windows-amd64.exe", IDE: true}
	}
	if index == 5 {
...
func Binding(name string) (string, string, int, bool) {
	...
	if name == "windows/amd64" {
		return "windows/amd64", "\xa8\x93\xea̴}gj\x12!bi\xe6\xce)z\a$\x80\xc0\x9deH6X\x1dB\xf6\x19\x8d)k", 3, true
	}
	if name == "windows/386" {
