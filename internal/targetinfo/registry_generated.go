...
func descriptorAt(index int) Descriptor {
	...
	if index == 2 {
		return Descriptor{Name: "linux/aarch64", Backend: "linux/aarch64", Aliases: []string(nil), Family: "native_v1", OS: "linux", ISA: "aarch64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "aapcs64", Image: "elf", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "exit", "hosted"}, Tags: []string{"aarch64", "arm64", "linux", "unix"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xae, 0x3a, 0x3a, 0xcd, 0xe2, 0x4b, 0xee, 0xff, 0xe6, 0x94, 0x5, 0x9e, 0x23, 0xb1, 0xfd, 0x3e, 0x46, 0x69, 0x48, 0x28, 0x2f, 0xf0, 0xb, 0x6, 0x6b, 0xd8, 0x8f, 0x0, 0xc8, 0x9e, 0xaf, 0xc8}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "", IDE: false}
	}
	if index == 3 {
	...
	if index == 6 {
		return Descriptor{Name: "windows/arm64", Backend: "windows/arm64", Aliases: []string(nil), Family: "native_v1", OS: "windows", ISA: "aarch64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "windows_arm64", Image: "pe", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"aarch64", "arm64", "windows"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted", "windows_gui"}, Definition: [32]uint8{0x41, 0xf6, 0x37, 0x9f, 0x4e, 0xcf, 0x14, 0xf7, 0x5a, 0x6c, 0x48, 0x19, 0x3, 0xb5, 0xeb, 0xfc, 0x79, 0x7e, 0xe6, 0x80, 0x2b, 0xb8, 0xe6, 0x4a, 0xfc, 0xcb, 0x5, 0x52, 0xc, 0xb, 0xfe, 0xe5}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "", IDE: true}
	}
	if index == 7 {
		return Descriptor{Name: "darwin/arm64", Backend: "darwin/arm64", Aliases: []string(nil), Family: "native_v1", OS: "darwin", ISA: "aarch64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "aapcs64", Image: "mach-o", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"aarch64", "arm64", "darwin", "unix"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xae, 0xc, 0x92, 0x25, 0xe9, 0x40, 0xf9, 0x1c, 0xb6, 0x21, 0x5b, 0x1a, 0xd, 0xba, 0x0, 0xe9, 0xb8, 0x9, 0x5d, 0x25, 0xe1, 0x3f, 0x7c, 0x7c, 0x1f, 0xd4, 0xb2, 0xf6, 0x13, 0x9e, 0xec, 0x2d}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-darwin-arm64", IDE: true}
	}
	if index == 8 {
