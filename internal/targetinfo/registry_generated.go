...
func descriptorAt(index int) Descriptor {
	...
	if index == 7 {
		return Descriptor{Name: "darwin/arm64", Backend: "darwin/arm64", Aliases: []string(nil), Family: "native_v1", OS: "darwin", ISA: "aarch64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "aapcs64", Image: "mach-o", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"aarch64", "arm64", "darwin", "unix"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xb1, 0x9c, 0x9d, 0xb1, 0xe, 0xb0, 0xf8, 0x52, 0x32, 0xd2, 0x73, 0x76, 0xd1, 0x2, 0x6c, 0xa7, 0x6f, 0x83, 0x2f, 0x74, 0x22, 0x91, 0x26, 0xbf, 0xd2, 0x35, 0xf7, 0x5d, 0xaa, 0x98, 0xa, 0x17}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-darwin-arm64", IDE: true}
	}
	if index == 8 {
