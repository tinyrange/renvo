...
func descriptorAt(index int) Descriptor {
	if index == 0 {
		return Descriptor{Name: "linux/amd64", Backend: "linux/amd64", Aliases: []string(nil), Family: "native_v1", OS: "linux", ISA: "amd64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "sysv_x86_64", Image: "elf", Runtime: []string{"read", "write", "open", "close", "read_at", "write_at", "chmod", "print", "exit", "hosted"}, Tags: []string{"amd64", "linux", "unix"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted", "linkstatic", "object"}, Definition: [32]uint8{0x64, 0x67, 0x6f, 0x90, 0xe0, 0x8e, 0x73, 0xbc, 0x6a, 0xc7, 0x79, 0x4a, 0x20, 0x8b, 0x95, 0x83, 0xcc, 0x23, 0xf, 0x32, 0xbc, 0xb1, 0x7a, 0xc3, 0x7e, 0xed, 0xd2, 0x43, 0xbe, 0x61, 0x63, 0x6a}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-linux-amd64", IDE: false}
	}
	if index == 1 {
	...
	if index == 4 {
		return Descriptor{Name: "windows/amd64", Backend: "windows/amd64", Aliases: []string(nil), Family: "native_v1", OS: "windows", ISA: "amd64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "windows_x86_64", Image: "pe", Runtime: []string{"open", "close", "read", "write", "read_at", "write_at", "seek", "print", "chmod", "exit", "hosted"}, Tags: []string{"amd64", "windows"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted", "imports", "linkstatic", "object", "windows_gui"}, Definition: [32]uint8{0x46, 0x9c, 0xb1, 0x38, 0xf8, 0x6a, 0x3b, 0x7e, 0xb8, 0xa4, 0x91, 0x9a, 0x48, 0x77, 0x12, 0x16, 0x82, 0x92, 0x80, 0x33, 0x37, 0xee, 0x8a, 0xda, 0x30, 0x3c, 0xeb, 0x3b, 0xa2, 0x9a, 0x97, 0x76}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-windows-amd64.exe", IDE: true}
	}
	if index == 5 {
	...
	if index == 8 {
		return Descriptor{Name: "wasi/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "wasi", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x4, 0xcb, 0x4f, 0x2c, 0xd5, 0xfa, 0x91, 0x60, 0x29, 0x1c, 0xcf, 0x62, 0xcb, 0xa5, 0xf9, 0xb5, 0xaf, 0xb8, 0x3b, 0xfb, 0x8a, 0x30, 0xf2, 0xd5, 0x14, 0xa3, 0x6e, 0x5f, 0xbc, 0xf0, 0x22, 0x94}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-wasi-wasm32.wasm", IDE: false}
	}
	if index == 9 {
		return Descriptor{Name: "browser/wasm32", Backend: "wasi/wasm32", Aliases: []string(nil), Family: "structured32", OS: "browser", ISA: "wasm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "html-wasm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"browser", "wasi", "wasip1", "wasm", "wasm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x82, 0x9b, 0x25, 0x6, 0xe4, 0xc5, 0xa0, 0x2, 0x2a, 0xfe, 0xc1, 0x1e, 0x67, 0x3e, 0xd6, 0xbe, 0xa4, 0xa0, 0x1a, 0xb9, 0x97, 0x4f, 0x7d, 0x16, 0x5, 0x97, 0x99, 0xcc, 0xc9, 0xd9, 0xf9, 0xeb}, DescriptorVersion: 3, Advertised: true, Virtual: true, DefaultArena: 134217728, ReleaseArtifact: "", IDE: true}
	}
	if index == 10 {
		return Descriptor{Name: "vm/vm32", Backend: "vm/vm32", Aliases: []string(nil), Family: "structured32", OS: "vm", ISA: "vm32", WordBits: 32, PointerBits: 32, CodePointerBits: 32, FunctionPointerBits: 32, MaxAlign: 8, Endian: "little", ABI: "vm32_internal", Image: "rnvm", Runtime: []string{"read", "write", "read_at", "write_at", "open", "close", "chmod", "print", "hosted"}, Tags: []string{"vm", "vm32"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xd7, 0xb2, 0x1d, 0x3e, 0x63, 0xdf, 0x93, 0xfc, 0xa7, 0x62, 0x7d, 0x62, 0xf0, 0x15, 0x9f, 0xe9, 0xc, 0x64, 0x5b, 0xa4, 0x8a, 0x93, 0x95, 0x47, 0xdc, 0x42, 0xe1, 0x4d, 0x72, 0x7e, 0x69, 0x3e}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-vm32.rnvb", IDE: false}
	}
	if index == 11 {
		return Descriptor{Name: "linux-kernel/amd64", Backend: "linux-kernel/amd64", Aliases: []string(nil), Family: "native_v1", OS: "linux", ISA: "amd64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "sysv_x86_64", Image: "elf-relocatable", Runtime: []string{"print", "open", "close", "read", "write", "chmod"}, Tags: []string{"amd64", "linux", "renvo_kernel", "unix"}, Capabilities: []string{"freestanding", "imports", "kernel_module", "linkstatic", "object"}, Definition: [32]uint8{0x72, 0x6c, 0x7e, 0x3b, 0xb6, 0xa7, 0xb8, 0xb7, 0x2c, 0x11, 0x7d, 0x20, 0xbb, 0x23, 0xb2, 0x51, 0x53, 0xcf, 0x93, 0x6b, 0xe2, 0xdf, 0x4a, 0x2d, 0x6f, 0x1e, 0xd8, 0x88, 0xf2, 0xcc, 0xff, 0x96}, DescriptorVersion: 3, Advertised: false, Virtual: false, DefaultArena: 0, ReleaseArtifact: "", IDE: false}
	}
	if index == 12 {
		return Descriptor{Name: "freebsd/amd64", Backend: "freebsd/amd64", Aliases: []string(nil), Family: "native_v1", OS: "freebsd", ISA: "amd64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "sysv_x86_64", Image: "elf", Runtime: []string{"read", "write", "open", "close", "read_at", "write_at", "chmod", "print", "exit", "hosted"}, Tags: []string{"amd64", "freebsd", "unix"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x20, 0x2, 0xc0, 0xd5, 0x28, 0x91, 0x84, 0x6c, 0x1d, 0xcc, 0x99, 0xae, 0x5e, 0x1a, 0xca, 0xe, 0xee, 0x4d, 0x6f, 0xca, 0x1f, 0x40, 0xdb, 0x79, 0xfb, 0x1f, 0x37, 0x45, 0x70, 0x62, 0xf5, 0x48}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-freebsd-amd64", IDE: false}
	}
	if index == 13 {
		return Descriptor{Name: "openbsd/amd64", Backend: "openbsd/amd64", Aliases: []string(nil), Family: "native_v1", OS: "openbsd", ISA: "amd64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "sysv_x86_64", Image: "elf", Runtime: []string{"read", "write", "open", "close", "read_at", "write_at", "chmod", "print", "exit", "hosted"}, Tags: []string{"amd64", "openbsd", "unix"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0xd6, 0x72, 0xb6, 0x65, 0x55, 0x78, 0x44, 0x7a, 0xab, 0xfd, 0x11, 0xea, 0xee, 0xa5, 0xd2, 0xcf, 0x3b, 0x9a, 0xfc, 0x79, 0x76, 0x4, 0xf9, 0x72, 0x2a, 0xae, 0x50, 0x60, 0x51, 0x94, 0x7e, 0xba}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-openbsd-amd64", IDE: false}
	}
	if index == 14 {
		return Descriptor{Name: "netbsd/amd64", Backend: "netbsd/amd64", Aliases: []string(nil), Family: "native_v1", OS: "netbsd", ISA: "amd64", WordBits: 64, PointerBits: 64, CodePointerBits: 64, FunctionPointerBits: 64, MaxAlign: 8, Endian: "little", ABI: "sysv_x86_64", Image: "elf", Runtime: []string{"read", "write", "open", "close", "read_at", "write_at", "chmod", "print", "exit", "hosted"}, Tags: []string{"amd64", "netbsd", "unix"}, Capabilities: []string{"argv", "environment", "executable", "filesystem", "heap", "hosted"}, Definition: [32]uint8{0x2d, 0xfd, 0x10, 0xf5, 0x73, 0x19, 0x1f, 0x6a, 0x37, 0xaa, 0x37, 0x87, 0xa4, 0x7, 0xe5, 0xdc, 0x6f, 0xdc, 0xa6, 0x71, 0xd6, 0xf, 0x53, 0xfc, 0xe4, 0x48, 0xcc, 0xc0, 0xd8, 0xdb, 0x27, 0xb9}, DescriptorVersion: 3, Advertised: true, Virtual: false, DefaultArena: 0, ReleaseArtifact: "renvo-netbsd-amd64", IDE: false}
	}
	return Descriptor{}
}
...
func Binding(name string) (string, string, int, bool) {
	...
	if name == "browser/wasm32" {
		return "browser/wasm32", "\x82\x9b%\x06\xe4Š\x02*\xfe\xc1\x1eg>־\xa4\xa0\x1a\xb9\x97O}\x16\x05\x97\x99\xcc\xc9\xd9\xf9\xeb", 3, true
	}
	if name == "vm/vm32" {
