...
func TestAppendWideConstantExpressions(t *testing.T) {
	for _, test := range []struct {
		...
		{"func main(){_=append([]byte{},'界')}", false},
		{"func main(){_=append([]int8{},'\\xff')}", false},
		{"func main(){_=append([]byte{},'\\xff')}", true},
		{"const R='界';func main(){_=append([]byte{},R)}", false},
		{"func main(){_=append([]byte{},'界'-'界'+'a')}", true},
	} {
