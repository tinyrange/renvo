...
func renvoBeginKernelModuleAmd64(g *renvoLinearGen, appIndex int) bool {
	...
	if g.c.objectFile {
		// A hosted ELF object exports this wrapper as ordinary System V main.
		// Preserve appMain's RAX result and do not pull module diagnostics,
		// managed arenas, or kernel imports into a freestanding C object.
...
// renvoAsmImageObjectAmd64 packages the kernel target's position-independent
// code as an ordinary System V ELF relocatable object. Unlike the module image
// path it deliberately has no BTF, vermagic, __this_module, or module wrapper
// sections. Kbuild and hosted C linker drivers can consume this common object
// contract directly.
