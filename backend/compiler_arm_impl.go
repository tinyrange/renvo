...
// unit: arm dd7e3809c5f95b89f05c646d165a2e4317099600cc01c1fd32d4bdabfdaca5d9
package main
...
func renvoArmAsmVFPIntToFloatStack(a *renvoAsm, offset int, intSize int, floatSize int, signed bool) {
	if intSize == 8 {
		...
		renvoAsmEmitText(a, "\x12\x2b\x43\xec\x02\x1b\x21\xee\x00\x0b\x31\xee") // vmov d2, r2, r3; vmul.f64 d1, d1, d2; vadd.f64 d0, d1, d0
		if floatSize == 4 {
...
func renvoArmAsmVFPFloatToIntStack(a *renvoAsm, dest int, source int, floatSize int, intSize int, signed bool) {
	if intSize == 8 {
		...
		if signed {
			...
			renvoAsmEmitText(a, "\x00\x00\x70\xe2\x00\x10\xe1\xe2") // rsbs r0, r0, #0; rsc r1, r1, #0
...
// Image assembly is terminal: reuse spare code capacity rather than keeping
// both the instruction buffer and a second executable-sized allocation live.
