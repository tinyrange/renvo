...
//go:generate go run ../../internal/rtg/cmd/rtggen -compiler-integration -arch x86_64 -package main -o ../compiler_amd64_impl.go x86_64_compiler.rtg
...
//go:generate go run ../../internal/rtg/cmd/rtggen -compiler-integration -arch x86_32 -package main -o ../compiler_386_impl.go x86_32_compiler.rtg
