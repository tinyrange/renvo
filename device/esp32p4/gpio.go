// Package esp32p4 provides reusable ESP32-P4 peripheral implementations.
package esp32p4
...
const (
	ioMuxBase        = uintptr(0x500e1004)
	gpioBase         = uintptr(0x500e0000)
	outputSelectBase = uintptr(gpioBase + 0x558)
	...
	gpioOutputSignal = uint32(0x500)
)

// Pin identifies one ESP32-P4 GPIO.
